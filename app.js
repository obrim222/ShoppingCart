...
const productSelect = document.querySelector(".banner-btn");
  ...
  async getProducts() {
    try {
      let result = await fetch(
        "https://raw.githubusercontent.com/obrim222/ShoppingCart/main/products.json"
      );
...
class UI {
  ...
  addCartItem(item) {
    ...
    div.innerHTML = `          <!--cart item---> 
        <img src=${item.image} alt="applewatch" class="img">
        <div>
          <h4>${item.title}</h4>
          <h5>${ccy}${item.price}</h5>
